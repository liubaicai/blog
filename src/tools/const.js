...
export default{
  install (Vue) {
    ...
    Vue.prototype.$footer = 'Powerby<a href="http://weibo.com/liubaicai" target="_blank">' +
      '@刘白菜</a>，项目源码托管于<a href="https://github.com/liubaicai/baicai_vue_blog" target="_blank">GitHub</a><p>Hosted by <a href="https://pages.coding.me" style="font-weight: bold">Coding Pages</a></p>'
  }
}
